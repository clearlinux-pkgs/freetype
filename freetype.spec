...
Source0  : https://download-mirror.savannah.gnu.org/releases/freetype/freetype-2.13.3.tar.gz
Source1  : https://download-mirror.savannah.gnu.org/releases/freetype/freetype-2.13.3.tar.gz.sig
...
%setup -q -n freetype-2.13.3
cd %{_builddir}/freetype-2.13.3
%patch -P 1 -p1
pushd ..
cp -a freetype-2.13.3 build32
popd
pushd ..
cp -a freetype-2.13.3 buildavx2
popd
pushd ..
cp -a freetype-2.13.3 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723485702
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libfreetype.so.6.20.2
/V4/usr/lib64/libfreetype.so.6.20.2
